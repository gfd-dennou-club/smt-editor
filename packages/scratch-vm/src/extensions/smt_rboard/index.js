	    ...
	    color1: '#4C97FF',
            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        id: 'rboard.led_all',
                        default: 'GPIO: set LEDs to 1:[ONOFF1] 2:[ONOFF2] 3:[ONOFF3] 4:[ONOFF4]'
                    }),
                ...
                {                    
                    ...
                    text: formatMessage({
			id: 'rboard.led',
                        default: 'GPIO: set pin [PIN] to [ONOFF]'
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
		    ...
		    arguments: {
                ...
                {                    
                    ...
                    text: formatMessage({
                        id: 'rboard.pwm_duty',
                        default:'PWM: set pin [PIN] duty to [DUTY]%',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN:  { type: ArgumentType.STRING, menu: 'menuLED' },
                ...
                {                    
                    ...
                    text: formatMessage({
                        ...
                        default:'PWM: set pin [PIN] frequency to [FREQ] Hz',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN:  { type: ArgumentType.STRING, menu: 'menuLED' },
