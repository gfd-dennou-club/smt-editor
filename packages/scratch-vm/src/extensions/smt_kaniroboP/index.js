...
//メニュー定義
const kaniroboPMenus = {
    menuMotorID: {
        items: [
            { id: 'kaniroboP.menuMotorID.right', default: '1', value: '2' },
            { id: 'kaniroboP.menuMotorID.left',  default: '2',  value: '6' }
        ]
    },
    menuMotorDir: {
        items: [
            { id: 'kaniroboP.menuMotorDir.forward',  default: 'forward',  value: '1' },
            { id: 'kaniroboP.menuMotorDir.backward', default: 'backward', value: '0' }
        ]
    },
    menuMototPower: {
        items: [
...
function createMenuItems(menuKey) {
    return kaniroboPMenus[menuKey].items.map(item => ({
...
class kaniroboP {
    ...
    getInfo() {
        return {
            id: 'kaniroboP',
            name: formatMessage({ id: 'kaniroboP.name', default: 'kaniroboP' }),
	    ...
	    color1: '#6cc04a',
            ...
            blocks: [
                {
                    opcode: 'motor',
                    text: formatMessage({ id: 'kaniroboP.motor', default: 'set motor [ID] speed to [PWR]% ([DIR])' }),
                ...
                {
                    opcode: 'sensor',
                    text: formatMessage({ id: 'kaniroboP.sensor', default: 'light sensor [ID] value' }),
                ...
                {
                    opcode: 'servo',
                    text: formatMessage({ id: 'kaniroboP.servo', default: 'set servo [ID] to [AGL] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
