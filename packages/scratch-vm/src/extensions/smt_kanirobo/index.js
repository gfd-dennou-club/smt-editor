    ...
    getInfo() {
        return {
            ...
            blocks: [
                {
                    opcode: 'motor',
                    text: formatMessage({ id: 'kanirobo.motor', default: 'set motor [ID] speed to [PWR]% ([DIR])' }),
                ...
                {
                    opcode: 'sensor',
                    text: formatMessage({ id: 'kanirobo.sensor', default: 'light sensor [ID] value' }),
                ...
                {
                    opcode: 'servo',
                    text: formatMessage({ id: 'kanirobo.servo', default: 'set servo [ID] to [AGL] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
