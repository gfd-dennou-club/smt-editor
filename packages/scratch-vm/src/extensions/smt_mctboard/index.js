    ...
    getInfo () {
	    ...
	    blocks: [
                {
                    ...
                    text: formatMessage({
                        id: 'mctboard.led_all',
                        default: 'set LEDs to [ONOFF1] [ONOFF2] [ONOFF3] [ONOFF4] [ONOFF5] [ONOFF6] [ONOFF7] [ONOFF8]'
                    }),
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'mctboard.sw_all',
                        default: 'switches are [ONOFF1] [ONOFF2] [ONOFF3] [ONOFF4]?'
                    }),
		...
		{                    
                    ...
                    text: formatMessage({
                        ...
                        default:'set led [PIN] brightness to [DUTY]%',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN:  { type: ArgumentType.STRING, menu: 'menuLED' },
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'mctboard.buzzer',
                        default: 'play note [NOTE] on buzzer'
                    }),
                    blockType: BlockType.COMMAND,
                    arguments: {
			NOTE: { type: ArgumentType.STRING, menu: 'menuNOTE' }
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'mctboard.temp',
                        default: 'thermistor temperature'
                    }),
                ...
                },
		{
                    ...
                    text: formatMessage({
                        id: 'mctboard.monitor',
                        default: 'write [TEXT] to LCD line [LINE]'
                    }),
                    blockType: BlockType.COMMAND,
                    arguments: {
...
/*
		    ...
		    text: formatMessage({
                        ...
                        default: 'init Wi-Fi (SSID: [SSID], passphrase: [PASS])',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
			...
			DATA: { type: ArgumentType.STRING, defaultValue: "{\"name\":\"hero\", \"tel\":\"foo\", \"num\":23}" }
                ...
                },
                {
                    opcode: 'time_mktime',
                    text: formatMessage({
                        id: 'mctboard.time_mktime',
                        default: 'set time to [YEAR]/[MON]/[DAY] [HOUR]:[MIN]:[SEC]',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
			...
			SEC:  { type: ArgumentType.NUMBER, defaultValue: 30 },
                ...
                },
                {
                    opcode: 'time_sync',
                    text: formatMessage({
                        id: 'mctboard.time_sync',
                        default: 'sync time with NTP server [NTP]',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
			NTP: { type: ArgumentType.STRING, defaultValue: 'ntp.nict.jp' }
                    }
                },
                {
                    opcode: 'time_now',
                    text: formatMessage({
                        id: 'mctboard.time_now',
                        default: 'update current time',
                    }),		    		    
                    blockType: BlockType.COMMAND
                },
                {
...
/*		
                {
                    ...
                    text: formatMessage({
                        id: 'mctboard.sd_open',
                        default: 'open file [FILE] as [MODE]'
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
