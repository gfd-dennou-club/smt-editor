    ...
    getInfo() {
	    ...
	    color1: '#4C97FF',
            ...
            blocks: [
                {
                    opcode: 'motor',
                    text: formatMessage({ id: 'kaniroboR.motor', default: 'set motor [ID] speed to [PWR]% ([DIR])' }),
                ...
                {
                    opcode: 'sensor',
                    text: formatMessage({ id: 'kaniroboR.sensor', default: 'light sensor [ID] value' }),
                ...
                {
                    opcode: 'servo',
                    text: formatMessage({ id: 'kaniroboR.servo', default: 'set servo [ID] to [AGL] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
