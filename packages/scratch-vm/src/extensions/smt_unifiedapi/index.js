	    ...
	    blocks: [
                {
                    ...
                    text: formatMessage({
                        ...
                        default:'GPIO: set pin [PIN] to mode [DIRECTION]',
                    }),
			...
			id: 'unifiedapi.gpio_write',
                        default:'GPIO: write [VALUE] to pin [PIN]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN: {
			...
			id: 'unifiedapi.gpio_read',
                        default:'GPIO: read value of pin [PIN]',
                    }),
                ...
                {                    
                    ...
                    text: formatMessage({
                        ...
                        default:'PWM: set up pin [PIN] (timer: [TIMER], frequency: [FREQ] Hz, duty cycle: [DUTY]%)',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN: {
                ...
                {                    
                    ...
                    text: formatMessage({
                        ...
                        default:'PWM: set duty cycle to [DUTY]% on pin [PIN]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default:'PWM: set frequency to [FREQ] Hz on pin [PIN]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default:'PWM: set pulse width to [PULSE] μs on pin [PIN]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        PIN: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default:'ADC: read raw count of pin [PIN]',
                    }),
                    blockType:BlockType.REPORTER,
                    arguments: {                     
                        PIN: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default:'ADC: read voltage of pin [PIN]',
                    }),
                    blockType:BlockType.REPORTER,
                    arguments: {                     
                        PIN: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'I2C [ADDR]: write [HEX1] [HEX2]'
                    }),		    
                    blockType: BlockType.COMMAND,
                    arguments: {
			ADDR: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'I2C [ADDR]: read [BYTES] bytes from register [HEX]'
                    }),	    
                    blockType: BlockType.REPORTER,
                    arguments: {
			ADDR: {
			...
			BYTES: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'SPI: set up (MISO: [MISO], MOSI: [MOSI], CLK: [CLK])' 
                    }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        MISO: {
			...
			BYTES: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'UART: set up ID [UART] (baud rate: [RATE])',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
                        UART: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'UART: send string [COMM] to ID [UART]',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
                        UART: {
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'UART: read string from ID [UART]',
                    }),		    		    
                    blockType: BlockType.REPORTER,
                    arguments: {
                        UART: {
                ...
                },		
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'UART: clear [TXRX] buffer of ID [UART]',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
                        UART: {
