...
const PeripheralsMenus = {
	...
	items: [
	    ...
	    {id: 'mctboard.menuTime_wday', default: '%w', value: 'wday' },
	    {id: 'mctboard.menuTime_hour', default: '%H', value: 'hour' },
	    {id: 'mctboard.menuTime_min',  default: '%M', value: 'min' },
	    {id: 'mctboard.menuTime_sec',  default: '%S', value: 'sec' },
...
*/
			...
			TEXT: { type: ArgumentType.STRING, defaultValue: "hogehoge" }
                ...
                {
                    opcode: 'time_sync_ntp',
                    text: formatMessage({
                        id: 'peripherals.time_time_sync_ntp',
                        default: 'Time: setup using [NTP]'
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
                        NTP: {
                            type: ArgumentType.STRING,
                            defaultValue: 'ntp.nict.jp'
                        }
                    }
                },
                {
                    opcode: 'time_mktime',
                    text: formatMessage({
                        id: 'peripherals.time_mktime',
                        default: 'Time: setup using year:[YEAR],month:[MON],day:[DAY],hour:[HOUR],minute:[MIN],second:[SEC]',
                    }),		    		    
                    blockType: BlockType.COMMAND,
                    arguments: {
