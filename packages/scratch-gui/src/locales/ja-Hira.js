...
*/
    "unifiedapi.name": "共通 I/O API",
    "unifiedapi.gpio_init":     'GPIO: ピン [PIN] をモード [DIRECTION] に設定する',
    "unifiedapi.gpio_write":    'GPIO: ピン [PIN] に [VALUE] を出力する',
    "unifiedapi.gpio_read":     'GPIO: ピン [PIN] の値を読み取る',
    "unifiedapi.pwm_init":      'PWM: ピン [PIN] を初期設定する (タイマー: [TIMER], 周波数: [FREQ] Hz, デューティ比: [DUTY]%)',
    "unifiedapi.pwm_duty":      'PWM: ピン [PIN] のデューティ比を [DUTY] %にする',
    "unifiedapi.pwm_frequency": 'PWM: ピン [PIN] の周波数を [FREQ] Hzにする',
    "unifiedapi.pwm_pulse":     'PWM: ピン [PIN] のパルス幅を [PULSE] μsにする',
    "unifiedapi.adc_init":      'ADC: ピン [PIN] を初期設定する',
    "unifiedapi.adc_raw":       'ADC: ピン [PIN] の生の値（カウント）を読み取る',
    "unifiedapi.adc_volt":      'ADC: ピン [PIN] の電圧を読み取る',
    "unifiedapi.i2c_init":      'I2C: 初期設定する',
    "unifiedapi.i2c_write":     'I2C [ADDR]: [HEX1] [HEX2] を書き込む',
    "unifiedapi.i2c_read":      'I2C [ADDR]: レジスタ [HEX] から [BYTES] バイト読み取る',
    "unifiedapi.spi_init":      'SPI: 初期設定する (MISO: [MISO], MOSI: [MOSI], CLK: [CLK])',
    "unifiedapi.spi_write":     'SPI: [HEX1] [HEX2] を書き込む',
    "unifiedapi.spi_read":      'SPI: [BYTES] バイト読み取る',
    "unifiedapi.uart_init":     'UART: ID [UART] を初期設定する (ボーレート: [RATE])',
    "unifiedapi.uart_puts":     'UART: ID [UART] に文字列 [COMM] を送信する',
    "unifiedapi.uart_gets":     'UART: ID [UART] から文字列を受信する',
    "unifiedapi.uart_clear":    'UART: ID [UART] の [TXRX] バッファをクリアする',
    "unifiedapi.num16": " 0x[NUM]",
    "unifiedapi.str": "[STR]の文字列化",
    "unifiedapi.str16": "[STR]の16進数表示",
    "unifiedapi.ord": "[STR]の文字コード",
    ...
    "peripherals.i2c_sensor_init":  'I2C: センサー[SENSOR] を初期化する',
    "peripherals.i2c_sensor_read":  'I2C: [SENSOR] 全データを取得する',
    "peripherals.i2c_sensor_value": 'I2C: [SENSOR] の [TARGET]',
    "peripherals.lcd_init":         'LCD: [LCD] を初期化する',
    "peripherals.lcd_cursor":       'LCD: [LCD] のカーソルを [LINE] 行目に移動する',
    "peripherals.lcd_print":        'LCD: [LCD] に[TEXT] と表示する',
    "peripherals.lcd_clear":        'LCD: [LCD] の画面を消去する',
    ...
    "peripherals.time_now":      'Time: 現在時刻を読み出し',
    "peripherals.time_value":    'Time: [TARGET]',
    "peripherals.wifi_init":     'Wi-Fi: 初期化する',
    "peripherals.wifi_connect":  'Wi-Fi: 接続する (SSID:[SSID] パスフレーズ:[PASS])',
    "peripherals.wifi_connected":'Wi-Fi: 接続済みか？',
    "peripherals.http_get":      'Wi-Fi: HTTP GET [URL]',
    "peripherals.http_post":     'Wi-Fi: HTTP POST で [DATA] を [URL] へ送信する',
    "peripherals.sd_init":   'SD: 初期化する (CS:[PIN]，フォルダ:[DIR])',
    "peripherals.sd_open":   'SD: ファイル [FILE] を開く (モード:[MODE])',
    "peripherals.sd_puts":   'SD+File: [TEXT] を書き込む',
    "peripherals.sd_gets":   'SD+File: 読み込む ([MODE])',
    "peripherals.sd_close":  'SD+File: ファイルを閉じる',    
    "peripherals.sd_umount": 'SD: マウント解除する',
/*
