...
export default {
    ...
    "kaniroboP.motor": "モーター[ID]を[DIR]方向にセット. スピード[PWR]%",
    "kaniroboP.sensor": "ライトセンサー[ID]の値",
    "kaniroboP.servo": "サーボモーター[ID]を[AGL]度にする",
    ...
    "mctboard.led_all": "LED を1:[ONOFF1] 2:[ONOFF2] 3:[ONOFF3] 4:[ONOFF4] 5:[ONOFF5] 6:[ONOFF6] 7:[ONOFF7] 8:[ONOFF8] にする",
    ...
    "mctboard.pwm_duty": "LED [PIN] の明るさを [DUTY]% にする",
    "mctboard.buzzer": "ブザーで[NOTE]の音を鳴らす",
    "mctboard.buzzer_stop": "ブザーの音を止める",
    "mctboard.temp": "サーミスタ温度計の温度",
    "mctboard.monitor": "LCDモニターの[LINE]行目に[TEXT]と書く",
    "mctboard.wifi_init": 'Wi-Fi の初期化 (SSID:[SSID]，パスフレーズ:[PASS])',
    "mctboard.wifi_connected": 'Wi-Fi は接続済みか?',
    "mctboard.http_get": 'HTTP GET [URL]',
    "mctboard.http_post": 'HTTP POST で[DATA] を[URL]へ送信する',
    "mctboard.time_mktime": "時計を[YEAR]/[MON]/[DAY] [HOUR]:[MIN]:[SEC]に設定する",
    "mctboard.time_sync":  '時計をNTP サーバ [NTP] へ同期する',
    "mctboard.time_now":   '現在時刻を読み出し',
    "mctboard.time_value": '時刻 [TIME]',
    "mctboard.gps_puts":  'GPS にコマンド[COMM]を送信する',
    "mctboard.gps_gets":  'GPSからデータを受信する',
    "mctboard.gps_clear": 'GPSのバッファをクリアする',
    "mctboard.sd_open":   'SDカードのファイル [FILE] を[MODE] モードで開く',
    "mctboard.sd_puts":   'SDカードに [TEXT] を書き込む',
    "mctboard.sd_gets":   'SDカードから [MODE] で読み込む',
    "mctboard.sd_close":  'SDカードのファイルを閉じる', 
    /*
    "mctboard3.lng": '経度',
    "mctboard3.lat": '緯度',
    "mctboard3.temp": '温度',
...
*/    
    ...
    "rboard.sw": "GPIO: スイッチ 1 は [ONOFF] か？",
    "rboard.pwm_duty": "PWM: [PIN] のデューティ比を [DUTY]% にする",
    "rboard.pwm_frequency": "PWM: [PIN] の周波数を [FREQ] Hz にする",    
