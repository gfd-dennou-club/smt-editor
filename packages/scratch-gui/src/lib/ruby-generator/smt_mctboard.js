...
export default function (Generator) {
    ...
    // PWM buzzer
    //
    Generator.mctboard_pwm_buzzer_init = function (){
        return (
    ...
    // Wi-Fi
    //
    Generator.mctboard_wifi_init = function () {
    ...
    // Time
    //
    Generator.mctboard_time_mktime = function (block) {
    ...
    Generator.mctboard_time_sync = function (block) {
        const ntp = Generator.valueToCode(block, 'NTP') || null;
        return (
	    `Time.sync_ntp( ${ntp} )\n`
	);
    };    

    Generator.mctboard_time_now = function (block) {
        return (
	    `time = Time.now\n`
	);
    };

    Generator.mctboard_time_value = function (block) {
        const time = Generator.getFieldValue(block, 'TIME') || null;
        return [`time.${time}`, Generator.ORDER_ATOMIC]
    };
